...
$CLJS.SHADOW_ENV.setLoaded("renderer.ipc.js");

goog.provide('renderer.ipc');
renderer.ipc.send_BANG_ = (function renderer$ipc$send_BANG_(){
return cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["hi there"], 0));
});
Object.defineProperty(module.exports, "send_BANG_", { enumerable: false, get: function() { return renderer.ipc.send_BANG_; } });
