...
var G__52625 = o;
goog.object.set(G__52625,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
var G__52650__i = 0, G__52650__a = new Array(arguments.length -  0);
while (G__52650__i < G__52650__a.length) {G__52650__a[G__52650__i] = arguments[G__52650__i + 0]; ++G__52650__i;}
  args = new cljs.core.IndexedSeq(G__52650__a,0,null);
} 
return G__52647__delegate.call(this,args);};
G__52647.cljs$lang$maxFixedArity = 0;
G__52647.cljs$lang$applyTo = (function (arglist__52651){
var args = cljs.core.seq(arglist__52651);
...
var G__52626 = o;
goog.object.set(G__52626,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__52656__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__52656 = function (var_args){
var args = null;
if (arguments.length > 0) {
...
while (G__52657__i < G__52657__a.length) {G__52657__a[G__52657__i] = arguments[G__52657__i + 0]; ++G__52657__i;}
  args = new cljs.core.IndexedSeq(G__52657__a,0,null);
} 
return G__52656__delegate.call(this,args);};
G__52656.cljs$lang$maxFixedArity = 0;
G__52656.cljs$lang$applyTo = (function (arglist__52658){
var args = cljs.core.seq(arglist__52658);
return G__52656__delegate(args);
});
...
var G__52627 = props;
var G__52627__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__52627,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__52627);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__52627__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__4212__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__52628 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__52628,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__52628;
}
})(),id_class);
...
var G__52629 = (cljs.core.count(argv) - first_child);
switch (G__52629) {
case (0):
...
var vec__52630 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52630,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52630,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52630,(2),null);
...
var temp__5757__auto___52701 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___52701 == null)){
} else {
var key_52702 = temp__5757__auto___52701;
(jsprops.key = key_52702);
}
...
var temp__5757__auto___52703 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___52703 == null)){
} else {
var key_52704 = temp__5757__auto___52703;
(jsprops.key = key_52704);
}
...
var temp__5757__auto___52706 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5757__auto___52706 == null)){
} else {
var key_52707 = temp__5757__auto___52706;
(jsprops.key = key_52707);
}
...
var temp__5757__auto___52735 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___52735 == null)){
} else {
var key_52736 = temp__5757__auto___52735;
(jsprops.key = key_52736);
}
...
var temp__5757__auto___52739 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___52739 == null)){
} else {
var key_52740 = temp__5757__auto___52739;
(jsprops.key = key_52740);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__52633_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__52633_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__52634 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52634,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52634,(1),null);
...
break;
default:
var G__52744 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__52745 = compiler;
v = G__52744;
compiler = G__52745;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template52640 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template52640 = (function (opts,id,fn_to_element,parse_fn,meta52641){
this.opts = opts;
this.id = id;
this.fn_to_element = fn_to_element;
this.parse_fn = parse_fn;
this.meta52641 = meta52641;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(reagent.impl.template.t_reagent$impl$template52640.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_52642,meta52641__$1){
var self__ = this;
var _52642__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template52640(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta52641__$1));
}));

(reagent.impl.template.t_reagent$impl$template52640.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_52642){
var self__ = this;
var _52642__$1 = this;
return self__.meta52641;
}));

(reagent.impl.template.t_reagent$impl$template52640.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template52640.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template52640.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template52640.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template52640.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template52640.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta52641","meta52641",-461440072,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template52640.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template52640.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template52640");

(reagent.impl.template.t_reagent$impl$template52640.cljs$lang$ctorPrWriter = (function (this__4450__auto__,writer__4451__auto__,opt__4452__auto__){
return cljs.core._write(writer__4451__auto__,"reagent.impl.template/t_reagent$impl$template52640");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template52640.
 */
reagent.impl.template.__GT_t_reagent$impl$template52640 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template52640(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta52641){
return (new reagent.impl.template.t_reagent$impl$template52640(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta52641));
});

}

return (new reagent.impl.template.t_reagent$impl$template52640(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
