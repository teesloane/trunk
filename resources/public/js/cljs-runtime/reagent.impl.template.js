...
var G__26741 = o;
goog.object.set(G__26741,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
var G__26742 = o;
goog.object.set(G__26742,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
while (G__26763__i < G__26763__a.length) {G__26763__a[G__26763__i] = arguments[G__26763__i + 0]; ++G__26763__i;}
  args = new cljs.core.IndexedSeq(G__26763__a,0,null);
} 
...
var G__26743 = props;
var G__26743__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__26743,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__26743);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__26743__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__4212__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__26744 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__26744,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__26744;
}
})(),id_class);
...
var G__26745 = (cljs.core.count(argv) - first_child);
switch (G__26745) {
case (0):
...
var vec__26746 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26746,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26746,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26746,(2),null);
...
var temp__5757__auto___26780 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___26780 == null)){
} else {
var key_26781 = temp__5757__auto___26780;
(jsprops.key = key_26781);
}
...
var temp__5757__auto___26782 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___26782 == null)){
} else {
var key_26783 = temp__5757__auto___26782;
(jsprops.key = key_26783);
}
...
var temp__5757__auto___26791 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5757__auto___26791 == null)){
} else {
var key_26792 = temp__5757__auto___26791;
(jsprops.key = key_26792);
}
...
var temp__5757__auto___26801 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___26801 == null)){
} else {
var key_26807 = temp__5757__auto___26801;
(jsprops.key = key_26807);
}
...
var temp__5757__auto___26809 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___26809 == null)){
} else {
var key_26810 = temp__5757__auto___26809;
(jsprops.key = key_26810);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__26749_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__26749_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__26750 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26750,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26750,(1),null);
...
break;
default:
var G__26825 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__26826 = compiler;
v = G__26825;
compiler = G__26826;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template26756 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template26756 = (function (opts,id,fn_to_element,parse_fn,meta26757){
this.opts = opts;
this.id = id;
this.fn_to_element = fn_to_element;
this.parse_fn = parse_fn;
this.meta26757 = meta26757;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(reagent.impl.template.t_reagent$impl$template26756.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_26758,meta26757__$1){
var self__ = this;
var _26758__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template26756(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta26757__$1));
}));

(reagent.impl.template.t_reagent$impl$template26756.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_26758){
var self__ = this;
var _26758__$1 = this;
return self__.meta26757;
}));

(reagent.impl.template.t_reagent$impl$template26756.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template26756.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template26756.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template26756.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template26756.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template26756.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta26757","meta26757",1866605864,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template26756.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template26756.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template26756");

(reagent.impl.template.t_reagent$impl$template26756.cljs$lang$ctorPrWriter = (function (this__4450__auto__,writer__4451__auto__,opt__4452__auto__){
return cljs.core._write(writer__4451__auto__,"reagent.impl.template/t_reagent$impl$template26756");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template26756.
 */
reagent.impl.template.__GT_t_reagent$impl$template26756 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template26756(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta26757){
return (new reagent.impl.template.t_reagent$impl$template26756(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta26757));
});

}

return (new reagent.impl.template.t_reagent$impl$template26756(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
