...
var cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_28633 = (function (port,fn1_handler){
...
return cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_28633(port,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_28638 = (function (port,val,fn1_handler){
var x__4509__auto__ = (((port == null))?null:port);
...
return cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_28638(port,val,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_28642 = (function (chan){
...
return cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_28642(chan);
}
});

var cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_28644 = (function (chan){
var x__4509__auto__ = (((chan == null))?null:chan);
...
return cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_28644(chan);
}
});
...
var cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_28650 = (function (h){
...
return cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_28650(h);
}
});

var cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_28657 = (function (h){
var x__4509__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_28657(h);
}
});

var cljs$core$async$impl$protocols$Handler$commit$dyn_28659 = (function (h){
var x__4509__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$commit$dyn_28659(h);
}
});
...
var cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_28664 = (function (b){
...
return cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_28664(b);
}
});

var cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_28665 = (function (b){
var x__4509__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_28665(b);
}
});

var cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_28666 = (function (b,itm){
var x__4509__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_28666(b,itm);
}
});

var cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_28667 = (function (b){
var x__4509__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_28667(b);
}
});
