...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_27939 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_27939(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_27944 = (function (reader){
var x__4509__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_27944(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_27948 = (function (reader,ch){
var x__4509__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_27948(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_27955 = (function (reader){
var x__4509__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_27955(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_27960 = (function (reader){
var x__4509__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_27960(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_27967 = (function (reader){
var x__4509__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_27967(reader);
}
});
...
var G__28064 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__28065 = s.append(c);
c = G__28064;
s = G__28065;
continue;
}
