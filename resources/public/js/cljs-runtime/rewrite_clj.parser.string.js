...
if((c === "\n")){
var G__29788 = escape_QMARK_;
var G__29789 = rewrite_clj.parser.string.flush_into(lines,buf);
escape_QMARK_ = G__29788;
lines = G__29789;
continue;
} else {
buf.append(c);
...
var G__29785 = rewrite_clj.parser.string.read_string_data(reader);
return (rewrite_clj.node.string_node.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.node.string_node.cljs$core$IFn$_invoke$arity$1(G__29785) : rewrite_clj.node.string_node.call(null,G__29785));
});
...
var G__29786 = cljs.core.re_pattern(regex);
var G__29787 = ["#\"",regex,"\""].join('');
return (rewrite_clj.node.token_node.cljs$core$IFn$_invoke$arity$2 ? rewrite_clj.node.token_node.cljs$core$IFn$_invoke$arity$2(G__29786,G__29787) : rewrite_clj.node.token_node.call(null,G__29786,G__29787));
});
